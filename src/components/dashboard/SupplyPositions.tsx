...
import { MOCK_SUPPLY_POSITIONS, formatCurrency, formatAPY } from "@/lib/mockData";
    ...
    <div style={{
      ...
      <div style={{
        ...
        <span style={{
          ...
          backgroundColor: "rgba(70,188,75,0.15)", color: "var(--aave-green)",
        }}>
          {MOCK_SUPPLY_POSITIONS.length} active
        </span>
      </div>
      ...
      {MOCK_SUPPLY_POSITIONS.map((pos, i) => (
        <div key={pos.symbol} style={{
          ...
          gap: "16px",
          alignItems: "center",
          borderBottom: i < MOCK_SUPPLY_POSITIONS.length - 1 ? "1px solid var(--aave-border-subtle)" : "none",
        }}>
          ...
          <div style={{ fontSize: "14px", fontWeight: 600, color: "var(--aave-green)" }}>
            {formatAPY(pos.apy)}
          </div>
