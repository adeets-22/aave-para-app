    ...
    <div
      ...
      <div
        ...
        <span
          ...
          style={{ backgroundColor: "var(--aave-bg-hover)", color: "var(--aave-green)" }}>
          {MOCK_SUPPLY_POSITIONS.length} positions
        </span>
      </div>
      ...
      {MOCK_SUPPLY_POSITIONS.map((pos, i) => (
        <div
          ...
          style={{
            gridTemplateColumns: "40% 25% 20% 15%",
            borderBottom: i < MOCK_SUPPLY_POSITIONS.length - 1 ? "1px solid var(--aave-border)" : "none",
          }}>
          {/* Asset */}
